...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            <form id="TypeValidation" class="form-horizontal" action="{{ route('admin.articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <textarea id="description-textarea" name="texte" rows="20">{!! $article->texte !!}</textarea>
                        </div>
                    </div>
                    <div class="row">
