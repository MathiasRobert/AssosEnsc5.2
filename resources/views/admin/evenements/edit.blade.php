...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            <form id="TypeValidation" class="form-horizontal" action="{{ route('admin.evenements.update', $evenement->id) }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <textarea id="description-textarea" name="description" rows="20">{!! $evenement->description !!}</textarea>
                        </div>
                    </div>
                </div>
