...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            <form id="TypeValidation" class="form-horizontal" action="{{ route('admin.evenements.store') }}" method="post" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <div class="card-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <textarea id="description-textarea" name="description" rows="20"></textarea>
                        </div>
                    </div>
                </div>
